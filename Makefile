.PHONY: create_environment requirements clean data build_documentation serve_documentation
...
## Build docker files
build:
    docker build --tag europe-west1-docker.pkg.dev/medtech-hack24cop-4046/hackathon/streamlit-app .

push:
    docker push europe-west1-docker.pkg.dev/medtech-hack24cop-4046/hackathon/streamlit-app
